...
For example, AHA does not incorporate evaluation of multiple release strategies, sub-cohorts of hatchery origin fish released at different sizes that mature and survive at different rates, and does not incorporate full stochasticity to encompass the range of uncertainty in biological and fitness dynamics.

We present salmonMSE, a comprehensive decision support tool to provide a risk-based approach for prioritizing management levers. 
