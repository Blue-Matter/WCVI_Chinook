...
A reference grid was developed from a factorial combination of three in-river exploitation rate targets (0.5, 0.75, and 1) and three target pNOB values (0.5, 0.75, and 1.00) in a factorial combination, leading to nine (9) scenarios.
...
14. Declining maturity and fecundity. The Sarita ERM estimates declining maturity (earlier age of maturity) in recent decades. The reference grid uses a recent mean, but this scenario uses the trend during 1990--2018 and continues the trend into the projection (Figure \@ref(fig:mat-trend)). Fecundity at age decreased during the projection (Figure \@ref(fig:fec-trend)). A 5 percent reduction in size at age per decade was used, and the corresponding fecundity was calculated from the fecundity-at-length model in @brown2025.
